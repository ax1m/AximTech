...
public class OreDictHandler {
    ...
    private static Map<String, Object> modMaterials = new HashMap<String, Object>();
    ...
    public static void register(String ore, ItemStack iStack) {
        OreDictionary.registerOre(ore, iStack);
    }
